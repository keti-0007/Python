...
count = 0 # переменная куда будет складываться кол-во дней выше 0
max_day_positive = 0 # переменная для макс-ого кол-ва дней  оттепели(выше 0)
for i in range(n):
...
print(f'{max_day_positive} - длилась самая длинная оттепель.')